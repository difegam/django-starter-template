---
name: daisyUI 5 Component Library
description:
  Comprehensive guide to daisyUI 5 components, theming, and best practices for
  Tailwind CSS 4. Covers 50+ UI components with semantic class names, dark mode
  support, and customization patterns.
applyTo: 'src/**/templates/**/*.html,src/**/static/**/*.css'
version: 5.5.x
